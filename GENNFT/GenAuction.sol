...
contract ClockAuctionBase {
        ...
        returns (uint256)
    {
        ...
        if (price > 0) {
            ...
            gen.transferFrom(msg.sender, seller, sellerProceeds);
        }
        ...
        // gen.transferFrom(this, msg.sender, bidExcess);
...
contract ClockAuction is Pausable, ClockAuctionBase {
    ...
    function ClockAuction(address _nftAddress, address _genAddress, uint256 _cut) public {
        require(_cut <= 10000);
        ownerCut = _cut;

        ERC721 candidateContract = ERC721(_nftAddress);
        GEN genCandidateContract = GEN(_genAddress);
        // require(candidateContract.supportsInterface(InterfaceSignature_ERC721));
        nonFungibleContract = candidateContract;
        gen = genCandidateContract;
    }
...
contract SaleClockAuction is ClockAuction {
    ...
    function SaleClockAuction(address _nftAddr, address _genAddr, uint256 _cut) public
        ClockAuction(_nftAddr, _genAddr, _cut) {}
